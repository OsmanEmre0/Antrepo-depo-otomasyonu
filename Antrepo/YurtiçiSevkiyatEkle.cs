...
namespace Antrepo
{
    public partial class YurtiçiSevkiyatEkle : Form
    {
        public YurtiçiSevkiyatEkle()
        {
            InitializeComponent();
        }
        ...
        public void KayitEkle()
        {
            try
            {
                ...
                string Sorgu = "Insert Into Yurticisevkiyat (GidecekMalzeme,MalzemeAdet,MalzemeFiyati,GondermeTarihi,Tasit,GonderilenYer) Values (@GidecekMalzeme,@MalzemeAdet,@MalzemeFiyati,@GondermeTarihi,@Tasit,@GonderilenYer)";
