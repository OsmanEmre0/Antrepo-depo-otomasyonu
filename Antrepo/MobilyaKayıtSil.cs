...
namespace Antrepo
{
    public partial class MobilyaKayıtSil : Form
    {
        public MobilyaKayıtSil()
        {
            InitializeComponent();
        }
        ...
        public void KayitSil()
        {
            ...
            {
                Stoklar.BaglantiAc();
                string Sorgu = "Delete from Mobilya where Mobilya_id=" + txtID5.Text;
                OleDbCommand SilKomut = new OleDbCommand(Sorgu, Stoklar.Baglanti);
                if (SilKomut.ExecuteNonQuery() == 1)
                    MessageBox.Show(txtID5.Text + "Kayıt Silindi", "UYARI");
