...
namespace Antrepo
{
    public partial class YurtiçiSevkiyatGuncelle : Form
    {
        public YurtiçiSevkiyatGuncelle()
        {
            InitializeComponent();
        }
        ...
        public void KayıtDegistir()
        {
            try
            {
                ...
                string Sorgu = "Update Yurticisevkiyat Set GidecekMalzeme=@GidecekMalzeme,MalzemeAdet=@MalzemeAdet,MalzemeFiyati=@MalzemeFiyati ,GondermeTarihi=@GondermeTarihi ,Tasit=@Tasit,GonderilenYer=@GonderilenYer  where Kimlik=@Kimlik";
